...
.directive('unitStudentList', ->
  ...
  scope:
    ...
    fullscreen: '=?'
  controller: ($scope, $rootScope, $state, Project, $filter, currentUser, alertService, unitService, taskService, projectService, gradeService, analyticsService, UnitStudentEnrolmentModal) ->
